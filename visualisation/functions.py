...
def grivanka():
    x = np.arange(-610, 610, 5)
    y = np.arange(-610, 610, 5)
    xgrid, ygrid = np.meshgrid(x, y)
...
def sinusoidalshvefel():
    x = np.arange(-510, 510, 5)
    y = np.arange(-510, 510, 5)
    xgrid, ygrid = np.meshgrid(x, y)
